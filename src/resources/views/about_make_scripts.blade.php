...
##【出力形式の指定】
- 出力は台本本文のみ。
- URL・出典・注釈・参照リンク・ニュースタイトルなどは書かない。
- 「ニュース1つ目」などの見出しや番号も不要。
- 改行と句読点で自然な間を取り、AI音声で自然に聞こえるように。
- 出力は“セリフ本文のみ”。
- 出典・ニュースソース名（例：Reuters、WHO、Natureなど）や括弧内の参照、URL表記も禁止。
- 話し手がニュースを「ナレーションとして紹介」する自然な語り口にする。
